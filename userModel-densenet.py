# authors: chaya.kolhar@accenture.com, raghotham.m.rao@accenture.com
...
audit1 = AdversarialInputs(model, IMAGE_SAMPLES_FOLDER, IMAGE_VS_LABELS_CSV, PATH_TO_SAVE_RESULTS, PROJECT_NAME,PATH_TO_JSON_INDEX_CLASS_MAPPING, threshold=0.1)
...
# audit2 = FourierRadialFiltering(model, IMAGE_SAMPLES_FOLDER, IMAGE_VS_LABELS_CSV, PATH_TO_SAVE_RESULTS,PATH_TO_JSON_INDEX_CLASS_MAPPING, radius=0.4,threshold=0.1)
# result = audit2.run()
# print(result)

# audit3 = ModelInterpretation(model, IMAGE_SAMPLES_FOLDER, IMAGE_VS_LABELS_CSV, PATH_TO_SAVE_RESULTS,PATH_TO_JSON_INDEX_CLASS_MAPPING, num_features=5, num_samples=200, hide_rest=True)
# result = audit3.run()
# print(result)

# audit4 = ObjectRecognitionWeakSignals(model, IMAGE_SAMPLES_FOLDER, IMAGE_VS_LABELS_CSV, PATH_TO_SAVE_RESULTS,PATH_TO_JSON_INDEX_CLASS_MAPPING, threshold=0.1)
...
# audit5 = RotationTranslation(model, IMAGE_SAMPLES_FOLDER, IMAGE_VS_LABELS_CSV, PATH_TO_SAVE_RESULTS,PATH_TO_JSON_INDEX_CLASS_MAPPING, threshold=0.1)
# result = audit5.run()
# print(result)
